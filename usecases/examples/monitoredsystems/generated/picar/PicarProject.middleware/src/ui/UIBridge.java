...
public class UIBridge {
	...
	static void register() {
		MonitoringMiddleware.getInstance().registerPicarRegistered(e -> {
			registerElement(((at.jku.lit.grum.picar.model.picar.Picar) e).getId());
		});
		MonitoringMiddleware.getInstance().registerLocationStateChange(e -> {
			updateElement(e);
		});
		MonitoringMiddleware.getInstance().registerStatusStateChange(e -> {
			updateElement(e);
		});
	}
	...
	static public void announceSystem() {
		RegisterElem elem = new RegisterElem("PicarSystem", "PicarSystem", "", " PicarSystem");
		prefix = "PicarSystem";
		parent = "PicarSystem";
	...
	static void registerElement(java.lang.String id) {
		try {
			RegisterElem elem = new RegisterElem(id, "at.jku.lit.grum.picar.model.picar.Picar", "PicarSystem",
					prefix + "/" + id);
