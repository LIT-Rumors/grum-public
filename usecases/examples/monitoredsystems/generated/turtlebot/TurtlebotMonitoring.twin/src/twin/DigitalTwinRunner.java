...
public class DigitalTwinRunner {
	...
	public void setup() throws Exception {
		...
		manager.subscribe("register/turtlebot");
		manager.subscribe("+/batterystatus");
		manager.subscribe("+/diagnostics");
		manager.subscribe("+/jointstate");
		manager.subscribe("+/laserscan");
		manager.subscribe("+/magneticfield");
		manager.subscribe("+/odometry");
		manager.subscribe("+/sensor");
		manager.subscribe("+/velocity");
		manager.subscribe("+/versioninfo");
