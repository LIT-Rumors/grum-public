 ...
 * @generated
 */
public class PicarSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PicarPackage.PICAR_SYSTEM: {
			PicarSystem picarSystem = (PicarSystem) theEObject;
			T result = casePicarSystem(picarSystem);
			if (result == null)
				result = caseIdableElement(picarSystem);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PicarPackage.PICAR: {
			Picar picar = (Picar) theEObject;
			T result = casePicar(picar);
			if (result == null)
				result = caseIdableElement(picar);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PicarPackage.LOCATION: {
			...
			if (result == null)
				result = caseIdableElement(location);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PicarPackage.STATUS: {
			...
			if (result == null)
				result = caseIdableElement(status);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PicarPackage.IDABLE_ELEMENT: {
	 ...
	 * @generated
	 */
	public T casePicarSystem(PicarSystem object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Picar</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Picar</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePicar(Picar object) {
		return null;
	}
