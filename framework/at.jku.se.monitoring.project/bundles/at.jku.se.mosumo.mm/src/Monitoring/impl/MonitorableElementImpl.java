 ...
 * </p>
 * <ul>
 *   <li>{@link Monitoring.impl.MonitorableElementImpl#getTopic <em>Topic</em>}</li>
 *   <li>{@link Monitoring.impl.MonitorableElementImpl#isSync <em>Sync</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MonitorableElementImpl extends NamedElementImpl implements MonitorableElement {
	...
	protected EClass eStaticClass() {
		return MonitoringPackage.Literals.MONITORABLE_ELEMENT;
	}
	...
	public void setTopic(String newTopic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MonitoringPackage.MONITORABLE_ELEMENT__TOPIC, oldTopic, topic));
	}
	...
	public void setSync(boolean newSync) {
		...
		sync = newSync;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MonitoringPackage.MONITORABLE_ELEMENT__SYNC, oldSync, sync));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MonitoringPackage.MONITORABLE_ELEMENT__TOPIC:
				return getTopic();
			case MonitoringPackage.MONITORABLE_ELEMENT__SYNC:
				return isSync();
		}
