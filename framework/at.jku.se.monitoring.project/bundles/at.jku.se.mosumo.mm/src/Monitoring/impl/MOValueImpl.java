 ...
 * </p>
 * <ul>
 *   <li>{@link Monitoring.impl.MOValueImpl#getEAttribute <em>EAttribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MOValueImpl extends MOElementImpl implements MOValue {
	...
	protected EClass eStaticClass() {
		return MonitoringPackage.Literals.MO_VALUE;
	}
		...
		if (eAttribute != null && eAttribute.eIsProxy()) {
			...
			if (eAttribute != oldEAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MonitoringPackage.MO_VALUE__EATTRIBUTE, oldEAttribute, eAttribute));
			}
		}
		return eAttribute;
	}
	...
	public void setEAttribute(EAttribute newEAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MonitoringPackage.MO_VALUE__EATTRIBUTE, oldEAttribute, eAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MonitoringPackage.MO_VALUE__EATTRIBUTE:
