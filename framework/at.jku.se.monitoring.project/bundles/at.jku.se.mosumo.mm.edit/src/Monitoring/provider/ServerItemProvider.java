...
/**
 * This is the item provider adapter for a {@link Monitoring.Server} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_connectionURL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_connectionURL_feature", "_UI_Server_type"),
				 MonitoringPackage.Literals.SERVER__CONNECTION_URL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MonitoringPackage.Literals.SERVER__CONNECTION_OPTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MonitoringPackage.Literals.SERVER__CONNECTION_OPTIONS,
				 MonitoringFactory.eINSTANCE.createConnectionOptions()));
	}
